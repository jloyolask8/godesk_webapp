 ...
 * @author jonathan
 */
public class ClientAgentDetectorFilter implements Filter {
    ...
    public ClientAgentDetectorFilter() {
    }
...
//        if (debug) {
//            log("ClientAgentDetectorFilter:DoBeforeProcessing");
//        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
//        if (debug) {
//            log("ClientAgentDetectorFilter:DoAfterProcessing");
//        }
...
//        if (debug) {
////            log("ClientAgentDetectorFilter:doFilter()");
//        }
...
//            if (debug) {
//                log("ClientAgentDetectorFilter:Initializing filter");
//            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ClientAgentDetectorFilter()");
        }
        StringBuffer sb = new StringBuffer("ClientAgentDetectorFilter(");
