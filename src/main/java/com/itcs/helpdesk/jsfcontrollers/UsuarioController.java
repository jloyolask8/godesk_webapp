...
//    private MeterGaugeChartModel meterGaugeModel;
    ...
    public MeterGaugeChartModel getMeterGaugeModel() {
        ...
        return new MeterGaugeChartModel(getJpaController().getCasoCountByEstado(current, EnumEstadoCaso.ABIERTO.getEstado()), intervals);
    }
...
//    }
    public List<Caso> getCasoAbiertoList() {
        ...
        estadoFilter.setIdCampo("idEstado");
        ...
        try {
            return getJpaController().findCasoEntities(vista, ((UserSessionBean) JsfUtil.getManagedBean("UserSessionBean")).getCurrent(), null);
...
//    }
    ...
    public String prepareCreate() {
        ...
        selectedItemIndex = -1;
//        setGruposDualListModel(new DualListModel<Grupo>((List<Grupo>)getJpaController().findAll(Grupo.class), new ArrayList<Grupo>()));
...
//        setGruposDualListModel(new DualListModel<Grupo>((List<Grupo>)getJpaController().findAll(Grupo.class), current.getGrupoList()));
...
//            updatedUser.setGrupoList(getGruposDualListModel().getTarget());
            if (updateFull) {
                getJpaController().merge(updatedUser);//:P
            } else {
