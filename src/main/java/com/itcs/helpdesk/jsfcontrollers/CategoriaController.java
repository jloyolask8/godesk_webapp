...
//    private transient PaginationHelper pagination;
    ...
    private transient TreeNode categorias = null;
...
//    private Area idArea;
    ...
    public int calculateOpenCases(Categoria cat) {
        ...
        try {
            return getJpaController().countEntities(vista1, userSessionBean.getCurrent()).intValue();
//            return getJpaController().countByCatFilter(cat, ((UserSessionBean) JsfUtil.getManagedBean("UserSessionBean")).getCurrent());
    ...
    public String prepareEdit(Integer idCategoria) {
        current = getJpaController().find(Categoria.class, idCategoria);
    ...
    private void performDestroy() {
        try {
            getJpaController().remove(Categoria.class, current.getIdCategoria());
...
//    }
    ...
    public DataModel getItemsNoPagination() {
        ...
        if ((textoFiltro != null) && (!textoFiltro.trim().isEmpty())) {
            ...
            lista = (List<Categoria>) getJpaController().findAll(Categoria.class);
        }
    ...
    public void crearCategoria(ActionEvent actionEvent) {
        try {
            ...
            Log.createLogger(this.getClass().getName()).log(Level.SEVERE, "crearCategoria", e);
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
...
//    }
    ...
    public TreeNode getCategorias(Usuario user) {
        System.out.println("getCategorias("+user+")");
        if (categorias != null) {
            return categorias;
        }
        System.out.println("searching categorias");
...
//    }
    ...
    public static class CategoriaControllerConverter implements Converter, Serializable {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().find(Categoria.class, getKey(value));
        }
