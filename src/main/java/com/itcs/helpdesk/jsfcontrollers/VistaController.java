...
//    }
    ...
    public JPAFilterHelper getFilterHelper2() {
        if (filterHelper2 == null) {
            filterHelper2 = new JPAFilterHelper(getSelected(), getJpaController()) {
                @Override
                public JPAServiceFacade getJpaService() {
                    return getJpaController();
                }
...
//            vista1.setIdUsuarioCreadaPor(EnumUsuariosBase.SISTEMA.getUsuario());
            ...
            filtroEstadoCerrado.setIdCampo("idEstado");
    ...
    public List<Vista> getVisibleForAllItems() {
        return getJpaController().findVistaEntitiesVisibleForAll();
    }
    ...
    public List<Vista> getVisibleForMeOnlyItems() {
        return getJpaController().findVistaEntitiesCreatedByUser(userSessionBean.getCurrent(), true, 0, 0);
    }
    ...
    public List<Vista> getVisibleForMyGroupsItems() {
        return getJpaController().findVistaEntitiesVisibleForGroupsOfUser(userSessionBean.getCurrent());
    }
    ...
    public List<Vista> getVisibleForMyAreasItems() {
        return getJpaController().findVistaEntitiesVisibleForAreasOfUser(userSessionBean.getCurrent());
    }
