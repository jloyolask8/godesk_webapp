...
//        comparableFieldsMap = getJpaController().getAnnotatedComparableFieldsMap(comparableFields);
    ...
    public JPAFilterHelper getFilterHelper2() {
        if (filterHelper2 == null) {
            filterHelper2 = new JPAFilterHelper(new Vista(Caso.class), getJpaController()) {
                @Override
...
//        campoCompCasoEjeYItemsEntity = new FiltroVista();
    ...
    public String generateModel() {
        try {
            if (campoCompCasoEjeXSeriesEntity != null) {
                setXaxisLabel(getFilterHelper().getComparableFieldsMap().get(campoCompCasoEjeXSeriesEntity.getIdCampo()).getLabel());
            }

            if (variables == 1) {
                createOneDimentionModel();
            } else if (variables == 2) {
                if (campoCompCasoEjeXSeriesEntity != null && campoCompCasoEjeXSeriesEntity.getIdCampo().equals(getCampoCompCasoEjeYItemsEntity().getIdCampo())) {
    ...
    private void createTwoDimentionModel() throws NotSupportedException, ClassNotFoundException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, Exception {
        ...
        try {
                    ...
                    if (campoCompCasoEjeXSeriesEntity.getIdComparador().equals(EnumTipoComparacion.SC.getTipoComparacion())) {
                        ...
                        for (String value : campoCompCasoEjeXSeriesEntity.getValoresList()) {
                            ...
                            if (value.equalsIgnoreCase(AbstractJPAController.PLACE_HOLDER_NULL)) {
                                ...
                                try {
                                    label = getJpaController().find(entity_x_type, value).toString();

                                } catch (java.lang.IllegalArgumentException e) {
                                    label = getJpaController().find(entity_x_type, Integer.valueOf(value)).toString();
                                }
                            }
                        ...
                        if (campoCompCasoEjeXSeriesEntity.getValor().equalsIgnoreCase(AbstractJPAController.PLACE_HOLDER_NULL)) {
                            ...
                            try {
                                label = getJpaController().find(entity_x_type, campoCompCasoEjeXSeriesEntity.getValor()).toString();

                            } catch (java.lang.IllegalArgumentException e) {
                                label = getJpaController().find(entity_x_type, Integer.valueOf(campoCompCasoEjeXSeriesEntity.getValor())).toString();
                            }
                        }
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Error in reporte", e);
        }
//        finally {
//            em.close();
//        }
                ...
                if (campoCompCasoEjeXSeriesEntity.getIdComparador().equals(EnumTipoComparacion.SC.getTipoComparacion())) {
                    ...
                    for (String value : campoCompCasoEjeXSeriesEntity.getValoresList()) {
                        ...
                        if (value.equalsIgnoreCase(AbstractJPAController.PLACE_HOLDER_NULL)) {
                            ...
                            try {
                                label = getJpaController().find(entity_type, value).toString();

                            } catch (java.lang.IllegalArgumentException e) {
                                label = getJpaController().find(entity_type, Integer.valueOf(value)).toString();
                            }
                        }
...
//                            serie.set(x.getLabel(), vistaController.countCasosForView(vista1));
                    ...
                    if (campoCompCasoEjeXSeriesEntity.getValor().equalsIgnoreCase(AbstractJPAController.PLACE_HOLDER_NULL)) {
                        ...
                        try {
                            label = getJpaController().find(entity_type, campoCompCasoEjeXSeriesEntity.getValor()).toString();

                        } catch (java.lang.IllegalArgumentException e) {
                            label = getJpaController().find(entity_type, Integer.valueOf(campoCompCasoEjeXSeriesEntity.getValor())).toString();
                        }
                    }
...
//            em.close();
    ...
    public String prepareCategoryModelCasosPorArea() {
        ...
        for (EstadoCaso estado : estados) {//series index
            ...
            for (Area a : areas) {//item index
                ...
                filtroEstado1.setIdCampo("idEstado");
    ...
    public String prepareCategoryModelCasosPorAgente() {
        ...
        for (EstadoCaso estado : estados) {
            ...
            filtroNotAssigned.setIdCampo("owner");
    ...
    public String preparePieModelEstadoCasos() {
        ...
        filtroCasosAbiertos.setIdCampo("idEstado");
        ...
        filtroCasosCerrados.setIdCampo("idEstado");
...
//==================OWNER
            ...
            filtroAsignadoAgente.setIdCampo("owner");
...
//==================FECHA_CREACION
            if (i != howManyPeriodsToShow) {
                FiltroVista filtroFecha1 = new FiltroVista();
                filtroFecha1.setIdCampo("fechaCreacion");
                filtroFecha1.setIdComparador(EnumTipoComparacion.GE.getTipoComparacion());
...
//--
            FiltroVista filtroFecha2 = new FiltroVista();
            filtroFecha2.setIdCampo("fechaCreacion");
            filtroFecha2.setIdComparador(EnumTipoComparacion.LT.getTipoComparacion());
...
//==================
            ...
            final int countCasosForView = vistaController.countCasosForView(view);

            final String name = (i) + (i > 1 ? " días" : " día") + (i != howManyPeriodsToShow ? "" : " o más");

            pieModel.set(name, countCasosForView);
            addOneDimTableValue(name, countCasosForView);
            vistaItems.add(view);
    ...
    public SelectItem[] getTiposDeGrafico() {
        ...
        if (this.getVariables() == 1) {
            ...
            items[0] = new SelectItem("pieChart", "Torta");
            items[1] = new SelectItem("barChart", "Barras");
            items[2] = new SelectItem("lineChart", "Lineas");
        } else if (this.getVariables() == 2) {
            items = new SelectItem[2];
            items[0] = new SelectItem("barChart", "Barras");
            items[1] = new SelectItem("lineChart", "Lineas");
        }
    ...
    public void itemSelect(ItemSelectEvent event) {
        ...
        try {
            ...
            casoController.applyVista(selected);
