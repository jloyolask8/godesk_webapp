...
public abstract class JPAFilterHelper implements Serializable {
    ...
    public static final String PLACE_HOLDER_NULL_LABEL = "No asignado (nulo)";
    public static final String PLACE_HOLDER_ANY_LABEL = "Cualquiera";
    private Vista vista;
...
//getJpaController().getIdentifieremf.getPersistenceUnitUtil().getIdentifier

    public JPAFilterHelper(Vista v, JPAServiceFacade jpaService) {
        this.vista = v;
...
//         return JsfUtil.getSelectItems(Collections.EMPTY_LIST, true);
        ...
        try {
            ...
            if (comparableField.getFieldTypeId().equals(EnumFieldType.SELECTONE_ENTITY.getFieldType())) {
                ...
                for (Object o : entities) {
                    selectItems.add(new SelectItem(jpaService.getIdentifier(o), o.toString()));
                }
    ...
    public SelectItem[] findPosibleOptionsIncludingAllPlaceHolders(String idCampo, Usuario who) {
        System.out.println("findPosibleOptionsIncludingAllPlaceHolders...");
        ...
        try {
            ...
            if (fieldType.equals(EnumFieldType.TEXT.getFieldType()) || fieldType.equals(EnumFieldType.TEXTAREA.getFieldType())) {
                ...
                if (comparable.getTipo().equals(List.class)) {
                    ...
                    throw new Exception("you can use SELECT_MANY_ENTITIES only in a List entity field.");
                }
