...
//    private ApplicationBean applicationBean;
    ...
    private String tenantId;//mapped to a schema per account(company)
    protected transient JPAServiceFacade jpaController = null;

    //If is a Customer Session
    ...
    private List<String> templateThemes;
    ...
    public String getTenantId() {
        if (tenantId == null) {
            try {
                if (JsfUtil.getRequest() != null && JsfUtil.getRequest().getRequestURL() != null) {
                    tenantId = getHostSubDomain(JsfUtil.getRequest().getRequestURL().toString());
                }
            } catch (Exception e) {
                Log.createLogger(this.getClass().getName()).log(Level.SEVERE, "getTenantId", e);
                tenantId = null;
            }
        }
        return tenantId;
    ...
    public void setTenantId(String tenantId) {
        System.out.println("setTenantId:" + tenantId);
...
//    }
    ...
    public void init() {
        ...
        templateThemes = new ArrayList<String>();
