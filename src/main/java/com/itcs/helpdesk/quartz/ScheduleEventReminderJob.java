...
//    public static final int RETRY = 3;
     ...
     * {0} = idArea,
     */
    public static final String JOB_ID = "%s_%s_RemindEvent_to_%s_e%sr_%s";

    public static String formatJobId(String schema, String idArea, String to, String eventId, String reminderId) {
        return String.format(JOB_ID, new Object[]{schema, idArea, to, eventId, reminderId});
    }
...
//            String email_text = (String) map.get(EMAIL_TEXT);
            ...
            final String formatJobId = formatJobId(schema, idArea, emails_to, eventId, reminderId);
            if (!StringUtils.isEmpty(idArea) && !StringUtils.isEmpty(schema) && !StringUtils.isEmpty(emails_to)
                ...
                try {
                    JPAServiceFacade jpaController = getJpaController(schema);
                    ...
                    if (event != null && eventReminder != null) {
                        ...
                        if (eventReminder.getReminderType().equalsIgnoreCase("EMAIL")) {
                            ...
                            if (instance != null) {
                                ...
                                Logger.getLogger(ScheduleEventReminderJob.class.getName()).log(Level.SEVERE, "Mail Not Configured for {0}", idArea);
